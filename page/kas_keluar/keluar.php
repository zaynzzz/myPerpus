<?php
    ...
    $no = 1;
    $data_keluar = mysqli_query($koneksi, "SELECT * FROM kas WHERE jenis = 'keluar' ");
    ...
    if(isset($_POST['simpan'])) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO kas (kode, keterangan, tgl, jumlah, jenis, keluar) VALUES ('$kode', '$ket', '$tgl', 0, 'keluar', '$jml')");
        ...
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            ...
            <div class="overflow-hidden">
                <table id="datatable" class="min-w-full">
                    ...
                    <tbody>
                        <?php foreach($data_keluar as $key => $item) : ?>
                            <tr class="bg-gray-100 border-b">
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    ...
                                    <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="?page=keluar&aksi=hapus&id=<?php echo $item['kode'];?>" class="text-white bg-red-500 px-2 py-1 rounded font-medium"><i class="fa fa-trash"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
