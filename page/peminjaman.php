...
<table class="w-full" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<th align="left" scope="col" class="text-white"> DATA TRANSAKSI PEMINJAMAN </th>
		</tr>
	<tr>
	  <td><hr /></td>
    </tr>
	...
	<td>
		<table class="w-full" border="0" align="center" cellpadding="4" cellspacing="1">
  			<tr>
    			<td colspan="7" align="right" valign="middle" scope="col"> <b><a href="?page=peminjaman_tambah" class="text-white">Tambah</a></b> </td>
   		  </tr>
          	<tr>
              ...
              <th width="17%" align="Center" scope="col" bgcolor="#66B2A8"><font color="#FFFFFF">Aksi</font></th>
		  </tr>

<?php
$no = 1;
$sql =
  "SELECT * FROM peminjamantbl inner join peminjamtbl on peminjamantbl.kode_peminjam = peminjamtbl.kode_peminjam ORDER BY peminjamantbl.id DESC";
...
while ($record = mysqli_fetch_array($proses)) { ?>
  <tr>
    ...
    <th align="Center" scope="col" bgcolor="#CCCCCC"><a href="?page=peminjaman_hapus&amp;id=<?php echo $record[
      'kode_peminjaman'
