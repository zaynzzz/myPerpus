...
<?php
$sql = "select * from pengembaliantbl order by id desc";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<th align="left" scope="col"><font face="Tahoma, Geneva, sans-serif" color="#000000" size="3">TRANSAKSI PENGEMBALIAN</font></th>
  </tr>
	<tr>
	  <td><hr /></td>
  </tr>
	<tr>
	<td>
  <form  id="form1" name="form1" method="post" action="?page=pengembalian_simpan">
<div class="md:w-1/2 px-3 my-6 md:mb-0">
      <label class="block uppercase tracking-wide text-white text-xs font-bold mb-2" for="grid-first-name">
      Kode Pengembalian
      </label>
      <input required class="appearance-none block bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-1 mb-3 leading-tight focus:outline-none focus:bg-white" name="kdpengembaliantxt" type="text" id="kdpengembaliantxt" size="5" maxlength="5" value="<?php
      echo "TK-";
      echo $record['id'] + 1;
      ?>" readonly="readonly" >
...
<!-- <form id="form1" name="form1" method="post" action="index.php?go=Pengembalian_Simpan">
  <table width="400" border="0" align="left">
    <tr>
      <td width="32%" align="left" valign="middle">Kode  Pengembalian</td>
      <td width="2%" align="left" valign="middle">:</td>
      <td width="66%" align="left" valign="top"><input name="kdpengembaliantxt" type="text" id="kdpengembaliantxt" size="5" maxlength="5" value="<?php
      echo "TK-";
      echo $record['id'] + 1;
