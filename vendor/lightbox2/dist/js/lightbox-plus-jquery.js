...
(function (global, factory) {
  ...
  Data.prototype = {
    ...
    remove: function (owner, key) {
      ...
      if (key === undefined || jQuery.isEmptyObject(cache)) {
        ...
        // https://bugs.chromium.org/p/chromium/issues/dashboard?id=378607 (bug restricted)
        if (owner.nodeType) {
  ...
  //	5. Avoid exposing implementation dashboards on user objects (eg. expando properties)
  ...
  // https://bugs.chromium.org/p/chromium/issues/dashboard?id=470258
  ...
  var /* eslint-disable max-len */
    ...
    // See https://connect.microsoft.com/IE/feedback/dashboards/1736512/
  ...
  // Related ticket - https://bugs.chromium.org/p/chromium/issues/dashboard?id=449857
  if (!support.focusin) {
  ...
  // Blink bug: https://bugs.chromium.org/p/chromium/issues/dashboard?id=589347
...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function () {
    ...
    var self = this;
    $(
      '<div id="lightboxOverlay" class="lightboxOverlay"></div><div id="lightbox" class="lightbox"><div class="lb-outerContainer"><div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" /><div class="lb-nav"><a class="lb-prev" href="" ></a><a class="lb-next" href="" ></a></div><div class="lb-loader"><a class="lb-cancel"></a></div></div></div><div class="lb-dataContainer"><div class="lb-data"><div class="lb-dashboards"><span class="lb-caption"></span><span class="lb-number"></span></div><div class="lb-closeContainer"><a class="lb-close"></a></div></div></div></div>'
    ).appendTo($("body"));
  ...
  // Display the image and its dashboards and begin preload neighboring images.
  ...
  Lightbox.prototype.updatedashboards = function () {
    var self = this;
